...
export { rule as noInlineIfBody } from './ts/no-inline-if-body.js'
...
export { rule as unityEditorPrefixGuard } from './unity/editor-prefix-guard.js'
...
export type { Config as NoInlineIfBodyConfig } from './ts/no-inline-if-body.js'
...
export type { Config as UnityEditorPrefixGuardConfig } from './unity/editor-prefix-guard.js'
...
import { rule as noInlineIfBody } from './ts/no-inline-if-body.js'
...
import { rule as unityEditorPrefixGuard } from './unity/editor-prefix-guard.js'
